...
INSERT INTO books VALUES (7, "Book31",  now()      , 2);
INSERT INTO books VALUES (8, "Book32",  now()      , 2);
...
-- GROUP BY                                        --
-- --------------------------------------------------
SELECT count(pubs.Name) AS Published,pubs.Name
FROM books
INNER JOIN pubs
ON books.PubID=pubs.ID
GROUP BY pubs.Name;